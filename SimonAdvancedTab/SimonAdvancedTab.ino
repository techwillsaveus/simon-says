 ...
 * THE ADVANCED TAB
 * HERE BE DRAGONS
 * This contains two frequently used functions by the
 * Gamer, showScore(digit,digit) and
 * printString(string,delay). Currently only showScore is
 * used in Simon Says, so why not find a way to add
 * printString to it as well?
 * You could also find a way to stop the game from
 * breaking if someone scores more than 50, or even add
 * difficulty levels!
*/
...
void showScore(int score) {
  ...
  dig2 = score%10;
  for(int p=0;p<8;p++) {
    result[p]=numbers[dig1][p]^(numbers[dig2][p]>>5);
  }
  gamer.printImage(result);
}

void setupScore() {
  numbers[1][0] = B10000000;
  numbers[1][1] = B10000000;
  numbers[1][2] = B10000000;
  numbers[1][3] = B10000000;
  numbers[1][4] = B10000000;
  numbers[1][5] = B10000000;
  numbers[1][6] = B10000000;
  numbers[1][7] = B10000000;

  numbers[2][0] = B11100000;
  numbers[2][1] = B00100000;
  numbers[2][2] = B00100000;
  numbers[2][3] = B11100000;
  numbers[2][4] = B10000000;
  numbers[2][5] = B10000000;
  numbers[2][6] = B10000000;
  numbers[2][7] = B11100000;

  numbers[3][0] = B11100000;
  numbers[3][1] = B00100000;
  numbers[3][2] = B00100000;
  numbers[3][3] = B01100000;
  numbers[3][4] = B00100000;
  numbers[3][5] = B00100000;
  numbers[3][6] = B00100000;
  numbers[3][7] = B11100000;

  numbers[4][0] = B10100000;
  numbers[4][1] = B10100000;
  numbers[4][2] = B10100000;
  numbers[4][3] = B11100000;
  numbers[4][4] = B00100000;
  numbers[4][5] = B00100000;
  numbers[4][6] = B00100000;
  numbers[4][7] = B00100000;

  numbers[5][0] = B11100000;
  numbers[5][1] = B10000000;
  numbers[5][2] = B10000000;
  numbers[5][3] = B11100000;
  numbers[5][4] = B00100000;
  numbers[5][5] = B00100000;
  numbers[5][6] = B00100000;
  numbers[5][7] = B11100000;

  numbers[6][0] = B11100000;
  numbers[6][1] = B10000000;
  numbers[6][2] = B10000000;
  numbers[6][3] = B11100000;
  numbers[6][4] = B10100000;
  numbers[6][5] = B10100000;
  numbers[6][6] = B10100000;
  numbers[6][7] = B11100000;

  numbers[7][0] = B11100000;
  numbers[7][1] = B00100000;
  numbers[7][2] = B00100000;
  numbers[7][3] = B00100000;
  numbers[7][4] = B00100000;
  numbers[7][5] = B00100000;
  numbers[7][6] = B00100000;
  numbers[7][7] = B00100000;

  numbers[8][0] = B11100000;
  numbers[8][1] = B10100000;
  numbers[8][2] = B10100000;
  numbers[8][3] = B11100000;
  numbers[8][4] = B10100000;
  numbers[8][5] = B10100000;
  numbers[8][6] = B10100000;
  numbers[8][7] = B11100000;

  numbers[9][0] = B11100000;
  numbers[9][1] = B10100000;
  numbers[9][2] = B10100000;
  numbers[9][3] = B11100000;
  numbers[9][4] = B00100000;
  numbers[9][5] = B00100000;
  numbers[9][6] = B00100000;
  numbers[9][7] = B11100000;

  numbers[0][0] = B11100000;
  numbers[0][1] = B10100000;
  numbers[0][2] = B10100000;
  numbers[0][3] = B10100000;
  numbers[0][4] = B10100000;
  numbers[0][5] = B10100000;
  numbers[0][6] = B10100000;
  numbers[0][7] = B11100000;
